package com.ssafy.Split.game.domain.entity;
...
public class Game {
    ...
    @Builder
    public Game(User user, LocalDateTime gameDate, Boolean isSkip, BigDecimal poseHighscore, BigDecimal poseLowscore, BigDecimal poseAvgscore, BigDecimal elbowAngleScore, BigDecimal armStabilityScore, BigDecimal armSpeed, Rank rank) {
        this.user = user;
