...
from training.train import epoch_not_finished,epoch, save_model
...
# # 저장된 JSON 파일을 읽어오기
#     with open("C:\\Users\\SSAFY\\code\\PJT\\S12P11B202\\AI\\classfication_bowling\\preprocessing\\bowling_walking_skeleton_data.json", "r", encoding="utf-8") as f:
#         dataset = json.load(f)
